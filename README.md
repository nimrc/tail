...
See [API documentation](http://godoc.org/github.com/nimrc/tail).
...
## Installing
    ...
    go get github.com/nimrc/tail/...

## Windows support

This package [needs assistance](https://github.com/nimrc/tail/labels/Windows) for full Windows support.
